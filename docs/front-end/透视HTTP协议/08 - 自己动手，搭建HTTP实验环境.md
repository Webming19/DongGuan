...
![](/front-end/透视HTTP/85cadf90dc96cf413afaf8668689ef0b.png)
...
![](/front-end/透视HTTP/862511b8ef87f78218631d832927bcee.png)
...
![](/front-end/透视HTTP/1af035861c4fd33cb42005eaa1f5f247.png)
...
![](/front-end/透视HTTP/ee7016fecd79919de550677af32f740a.png)

然后要注意，你必须把OpenResty的压缩包解压到刚才的“D:\\http\_study”目录里，并改名为“openresty”。

![](/front-end/透视HTTP/5acb89c96041f91bbc747b7e909fd4b5.png)
...
![](/front-end/透视HTTP/e5d35bb94c46bfaaf8ce5c143b2bb2da.png)
...
![](/front-end/透视HTTP/dba34b8a38e98bef92289315db29ee1d.png)
...
![](/front-end/透视HTTP/128d8a5ed9cdd666dbfa4e17fd39afc4.png)

然后我们打开Chrome，在地址栏输入“ `http://localhost`”，访问刚才启动的OpenResty服务器，就会看到一个简单的欢迎界面，如下图所示。

![](/front-end/透视HTTP/d7f12d4d480d7100cd9804d2b16b8a88.png)

这时再回头去看Wireshark，应该会显示已经抓到了一些数据，就可以用鼠标点击工具栏里的“停止捕获”按钮告诉Wireshark“到此为止”，不再继续抓包。

![](/front-end/透视HTTP/f7d05a3939d81742f18d2da7a1883179.png)
...
![unpreview](/front-end/透视HTTP/03727c2a64cbc628ec18cf39a6a526dd.png)
